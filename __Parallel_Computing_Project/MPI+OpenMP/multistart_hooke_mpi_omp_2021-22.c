...
int main(int argc, char *argv[])
{
	...
	int my_id, p; // ��� ���������� MPI ���� �� ������ �������� ��� rank ��� ��� size ��� process(����������) 
	int message_source; // ���� �� ��������� ��� �������� ���� �� �������� ��� ���� ��� ��������� 
	int tag = 1234; // ��������� ���� �� �������� �� tag ��� ���������
	int destination = 0; // ��������� ��� �� �������� ��� ��������� ��� ���������
	MPI_Status status; // ��������� ��� �� ���������� ��� ��������� ��� ���������
	...
	MPI_Init(&argc, &argv); /* �� ���� ��� ������ ������� �������� ������������� process (����������) */
	MPI_Comm_rank(MPI_COMM_WORLD, &my_id); /* ���� ID ��� ��������� ���������� (process) */
	MPI_Comm_size(MPI_COMM_WORLD, &p);	  /* ���� ������� ���������� (processes) */
	srand48(my_id + 1); /* �� ���� ��� ��� ������ ������������ ��� �� ���� ��������� �� ����� �� ����� �������� ������� */
#pragma omp parallel num_threads(num_of_threads) firstprivate(fx, jj, i) /* ��� ������� � ������������� ��� � ���������� ������� �� ��� ��������� num_threads(int). ��������, ������� ����� ��� �������/���������� firstprivate ��� �� ������� ������ ��� ���������� ��� ��� ���������� �� ������� ���������� ������ ��� ������� (threads)*/
	{
#pragma omp for // ��� ������� ��������������� ��� for-loop 
		for (trial = 0; trial < ntrials / p; trial++) /* ��������������� ������� ��� �������/������� ��� trials �� ���� ��������� (process). ��������: �� �� ��������������� � �������� �����, ���� ���� ��������� (process) �� ��������� ���� trials ��� ��� ���� ��� ���������� ntrials */
		{
			...
			printf("f(x) = %15.7le\n", fx);
#endif
#pragma omp critical /*mutex area (������� �������� ���������) ��� ��� ���������� ��� ��� ������ �� ������ ���������� , ��� ���������� �� ������ 2 ��� best �����������, ���� �� ���������� ����/�������� ���� �������� ��� ������������*/
			{
				if (fx < best_fx)
				{
	...
	if (my_id != 0) // ���� �� ���������� �� ������ ��� ����� id ��� �� 0 �� ������ �������� ��� ������������� ���� ��� ���������-������ (master process) � ����� ���� id = 0
	{
		MPI_Send(&best_fx, 1, MPI_DOUBLE, destination, tag, MPI_COMM_WORLD); // ���������������� �������� ��� ��������� ��� ����������-������� (workers-processes) ��� ���������-������ (master process)
	...
	{
		for (j = 1; j < p; j++) //	���� �� for-loop ���������� ��� ���� ���������-������ (worker-process)
		{
			message_source = j;
			MPI_Recv(&fx, 1, MPI_DOUBLE, message_source, tag, MPI_COMM_WORLD, &status); // ������� ������� ��� ��������� ��� ���� ���������� �� �������� ����� 
			...
			if (fx < best_fx) // ���'����� ������� �������� ��� ��������� ��� ����������-������ (master process) �� �� ��������� ��� ���� id=1 ��� ��� �������� �������� �� ��� ��������� ����������
			{
				best_trial = trial;
				best_jj = jj;
				best_fx = fx;
