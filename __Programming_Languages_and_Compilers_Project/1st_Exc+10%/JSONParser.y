...
%%
jsonfile: OBRACKETS {printf("{\n");} ruleLAST_RESULT CBRACKETS {printf("}\n");};


ruleLAST_RESULT: LAST {printf("\"last\"");} COLON {printf(":");} OBRACKETS {printf("{\n");} ruleLAST CBRACKETS {printf("}\n");} COMMA ACTIVE COLON {printf(":");} OBRACKETS ruleACTIVE CBRACKETS {printf("}\n");};
