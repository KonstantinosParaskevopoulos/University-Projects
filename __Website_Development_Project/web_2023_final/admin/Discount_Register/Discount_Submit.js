let data = {
  ...
  var featuresLayer = L.geoJSON(data, {
    filter: function (feature, marker){
      marker.bindPopup("1111");
      return typeof feature.properties.name!=='undefined';
     //Filters Undefined SuperMarkets
    }
  });
  /*
  L.geoJSON(data, {onEachFeature: function(feature,marker){
