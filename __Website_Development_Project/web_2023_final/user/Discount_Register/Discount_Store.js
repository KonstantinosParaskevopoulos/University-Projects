let data = {
    ...
    "timestamp": "2022-12-05T21:50:09Z",
    "features": [
      {
        "type": "Feature",
        "properties": {
    ...
    function onLocationFound(e) {            //Δημιουργία Συνάρτησης για σχεδίαση περιοχής που μπορεί
      ...
      var userCoordinates=JSON.stringify(e.latlng, null, 2)
      var obj = JSON.parse(userCoordinates);
      console.log(obj);
      ///////////////////////////////////////////
      var xhr = new XMLHttpRequest();

    //set the PHP page you want to send data to
      xhr.open("POST", "Discount_Store.php?data"+obj, true);
      //xmlhttp.open("GET","get_offers.php?q="+str,true);
      ...
      // send the data
      xhr.send(userCoordinates);var xhr = new XMLHttpRequest();
      /////////////////////////////////////////
